...
public class DefaultAdapter extends BaseAdapter {
    ...
    private ScaleSpringListener scaleListener;

    public interface ScaleSpringListener{
        void onItemTouchDown(View view);
        void onItemTouchUp(View view);
    }

    public void setScaleListener(ScaleSpringListener scaleListener) {
        this.scaleListener = scaleListener;
    }

    public ScaleSpringListener getScaleListener() {
    ...
    public View getView(final int index, View view, ViewGroup parent) {
        ...
        view.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if(motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                    scaleListener.onItemTouchDown(view);
                } else if (motionEvent.getAction() == MotionEvent.ACTION_CANCEL){
                    scaleListener.onItemTouchUp(view);
                }
                /** action up handler at onItemClickListener*/
                return false;
            }
        });
        switch (dialog.listType) {
            case SINGLE: {
                ...
                MDTintHelper.setTint(radio, Color.parseColor("#673AB7"));
