...
public class DatePickerDialog extends DialogFragment implements View.OnClickListener, DatePickerController{
	...
	public static DatePickerDialog newInstance(OnDateSetListener onDateSetListener, int year, int month, int day, Typeface typeface) {
		return newInstance(onDateSetListener, year, month, day, true , typeface);
	}

	public static DatePickerDialog newInstance(OnDateSetListener onDateSetListener, int year, int month, int day, boolean vibrate, Typeface typeface) {
		DatePickerDialog datePickerDialog = new DatePickerDialog();
		datePickerDialog.initialize(onDateSetListener, year, month, day, vibrate, typeface);
	...
	public void initialize(OnDateSetListener onDateSetListener, int year, int month, int day, boolean vibrate, Typeface typeface) {
		if (year > MAX_YEAR)
	...
	public View onCreateView(LayoutInflater layoutInflater, ViewGroup parent, Bundle bundle) {
		...
		Activity activity = getActivity();
		mDayPickerView = new DayPickerView(activity, this, mTypeface);
		mYearPickerView = new YearPickerView(activity, this, mTypeface);
