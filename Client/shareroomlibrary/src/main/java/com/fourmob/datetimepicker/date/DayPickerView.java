...
//    protected int mDaysPerWeek = 7;
	...
	public DayPickerView(Context context, DatePickerController datePickerController, Typeface typeface) {
		super(context);
	...
	protected void setUpAdapter() {
		if (mAdapter == null) {
			mAdapter = new SimpleMonthAdapter(getContext(), mController, mTypeface);
        }
