...
//    protected int mSelectedRight = -1;
	...
	public SimpleMonthView(Context context, Typeface typeface) {
		super(context);
...
//		mMonthTitleBGColor = resources.getColor(R.color.circle_background);
	...
	private void drawMonthTitle(Canvas canvas) {
        ...
        canvas.drawText(getMonthAndYearString().toUpperCase(), x, y, mMonthTitlePaint);
	}
...
//        mMonthTitleBGPaint.setColor(mMonthTitleBGColor);
        mMonthTitleBGPaint.setColor(Color.WHITE);
...
//        mMonthDayLabelPaint.setTypeface(Typeface.create(mDayOfWeekTypeface, Typeface.NORMAL));
        mMonthDayLabelPaint.setTypeface(mTypeface);
        ...
        mMonthNumPaint.setTypeface(mTypeface);
