...
public class Slider extends CustomView {
    ...
    private int backgroundColor = Color.parseColor("#3949AB");
    private Ball   ball;
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN || event.getAction() == MotionEvent.ACTION_MOVE) {
                ...
                if ((event.getX() <= getWidth() && event.getX() >= 0)) {
                    ...
                    if (numberIndicator != null) {
                        ...
                        numberIndicator.indicator.finalY = Utils.getRelativeTop(this) - getHeight();//note
...
//    }
	...
	protected void setAttributes(AttributeSet attrs) {
        ...
        showNumberIndicator = attrs.getAttributeBooleanValue(MATERIALDESIGNXML,"showNumberIndicator", true);
        min = attrs.getAttributeIntValue(MATERIALDESIGNXML, "min", 0);
        max = attrs.getAttributeIntValue(MATERIALDESIGNXML, "max", 100);
        value = attrs.getAttributeIntValue(MATERIALDESIGNXML, "value", min);

        ball = new Ball(getContext());
        RelativeLayout.LayoutParams params = new LayoutParams(Utils.dpToPx(15,getResources()), Utils.dpToPx(15, getResources()));
    ...
    class Indicator extends RelativeLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (animate) {
                ...
                y -= Utils.dpToPx(3, getResources());//note
    ...
    class NumberIndicator extends Dialog {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            numberIndicator.setTypeface(mTypeface);
