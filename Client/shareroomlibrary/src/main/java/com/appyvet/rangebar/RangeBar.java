...
//    private static final int DEFAULT_PIN_COLOR = 0xff3f51b5;
    private static final int DEFAULT_PIN_COLOR = Color.parseColor("#3949AB");
...
//    private static final int DEFAULT_CONNECTING_LINE_COLOR = 0xff3f51b5;
    private static final int DEFAULT_CONNECTING_LINE_COLOR = Color.parseColor("#3949AB");
    ...
    private int mDefaultHeight = 130;
...
//    private OnRangeBarTextListener mPinTextListener;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mIsRangeBar) {
            mLeftThumb = new PinView(ctx, mTypeface);
        ...
        mRightThumb = new PinView(ctx, mTypeface);
