...
public class StarBar extends View {
    ...
    private int yellowRangeStart = 2;
    private int greenRangeStart = 4;
...
//        labelPaint.setTypeface(Typeface.DEFAULT_BOLD);
    ...
    private void loadStars() {
        ...
        smallStars = new Drawable[] { res.getDrawable(R.drawable.photorating_slider_normal_red), res.getDrawable(R.drawable.photorating_slider_normal_orange), res.getDrawable(R.drawable.photorating_slider_normal_green) };
        largeStars = new Drawable[] { res.getDrawable(R.drawable.photorating_slider_pressed_red), res.getDrawable(R.drawable.photorating_slider_pressed_orange), res.getDrawable(R.drawable.photorating_slider_pressed_green) };
        textBounds = new Rect();
    }
